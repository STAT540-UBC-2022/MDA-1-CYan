...
1.  Replace the fields with “Not Available” with “0 indoor parking spots
...
```
    ...
    ## # … with 34 more variables: balconies <chr>,
...
```
    ...
    ## #   ¹​`Outdoor rec facilities`, ²​`Outdoor pool`, ³​`Indoor exercise room`,
